...
summary(regsimples)
coeftest(regsimples, vcov = vcovHC(regsimples,"HC0"))
...
summary(reg2)
coeftest(reg2, vcov = vcovHC(reg2,"HC0"))
...
summary(reg3)
coeftest(reg3, vcov = vcovHC(reg3,"HC0"))
...
summary(reg4)
coeftest(reg4, vcov = vcovHC(reg4,"HC0"))
...
stargazer(as.data.frame(base), type = "text", summary.stat = c("n","mean","median","sd","max","min"))
...
stargazer(as.data.frame(base_rb), type = "text")
stargazer(as.data.frame(base_rm), type = "text")
stargazer(as.data.frame(base_ra), type = "text")
...
stargazer(as.data.frame(base_pcb), type = "text")
stargazer(as.data.frame(base_pcm), type = "text")
stargazer(as.data.frame(base_pca), type = "text")
